<?php
	...
	$dictionary = array(
		...
		'Mostrar no máximo %s resultados',
		...
		'Deve ser um número válido ou parâmetro',
		...
		'Uma página index já existe.',

		'A 404 type page already exists.' => 
		'Uma página do tipo 404 já existe.',
		...
		'%s Ocultar esta seção do menu de publicação',
		...
		'A seção que você está procurando não podê ser encontrada.',

		'Section updated at %1$s. <a href="%2$s">Create another?</a> <a href="%3$s">View all Sections</a>' => 
		'Seção atualizada %1$s. <a href="%2$s">Criar outra?</a> <a href="%3$s">Ver todas Seções</a>',
		...
		'Uma seção com o nome <code>%s</code> já existe',
		...
		'A senha fornecida foi rejeitada. <a href="%s">Recuperar senha?</a>',
		...
		'Esta sessão expira em 2 horas. Se você não pediu por uma nova senha, por favor desconsidere este e-mail.',
		...
		'A seção que você esta procurando, <code>%s</code> não foi encontrada.',
		...
		'Autor atualizado %1$s. <a href="%2$s">Criar outro?</a> <a href="%3$s">Ver todos autores</a>',

		'Author created at %1$s. <a href="%2$s">Create another?</a> <a href="%3$s">View all Authors</a>' => 
		'Autor criado %1$s. <a href="%2$s">Criar outro?</a> <a href="%3$s">Ver todos autores</a>',
		...
		'Houve alguns problemas ao tentar salvar. Verifique os campos abaixo.',
	...
	/*
	 * EXTENSION: Filter: Email Template
	 * Localisation strings
	 */
	...
	$dictionary += array(
		...
		'Symphony &ndash; Email Templates' => 
		false,
		...
		'The parameter <code>%s</code> can be used in the selected datasources to get related data.' => 
		false,
	...
	$dictionary += array(
		...
		'Os autores podem selecionar um idioma diferente no perfil.',
	...
	/*
	 * EXTENSION: Field: Static Section
	 * Localisation strings
	 */
